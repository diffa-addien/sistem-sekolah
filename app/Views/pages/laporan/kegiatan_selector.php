...
<div class="max-w-xl mx-auto">
    ...
    <div class="p-4 bg-white rounded-lg shadow-md space-y-4">
        ...
        <button id="show_report_btn" class="w-full px-4 py-2 text-sm text-white bg-purple-600 rounded-lg disabled:bg-purple-300" disabled>Tampilkan Laporan</button>
    </div>
</div>
<?= $this->endSection() ?>
...
$(document).ready(function() {
    ...
    $('#show_report_btn').on('click', function() {
        ...
        if (studentId) {
            ...
            window.location.href = `<?= site_url('admin/laporan/kegiatan/siswa/') ?>${studentId}?academic_year_id=${academicYearId}`;
        }
    });
});
</script>

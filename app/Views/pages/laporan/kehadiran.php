            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y">
                    ...
                    <tr class="text-gray-700">
                        <td class="px-4 py-3 text-sm font-semibold sticky left-0 bg-white"><a href="<?= site_url('admin/laporan/siswa/' . $data['student_id']) ?>" class="hover:underline text-sky-600"><?= esc($data['full_name']) ?></a></td>

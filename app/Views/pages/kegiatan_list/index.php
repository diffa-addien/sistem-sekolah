...
<div class="flex justify-between items-center mb-4">
    ...
    <a href="<?= site_url('admin/nama-kegiatan/new') ?>" class="btn-primary">Tambah Nama Kegiatan</a>
</div>
                    ...
                    <tr class="text-gray-700">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex items-center space-x-4">
                                <a href="<?= site_url('admin/nama-kegiatan/' . $item['id'] . '/edit') ?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Edit">

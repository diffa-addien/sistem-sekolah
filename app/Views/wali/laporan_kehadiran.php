...
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="<?= site_url('wali/dashboard') ?>" class="flex items-center px-4 py-2 text-sm font-medium text-gray-600 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200">
    ...
    <div class="bg-white rounded-lg shadow-md p-4">
        ...
        <div class="grid grid-cols-7 gap-2">
            ...
            <?php while ($dayCounter <= $daysInMonth): ?>
                ...
                ?>
                <div class="p-2 border rounded-lg h-28 flex flex-col justify-between <?= $attendance_data ? $statusColors[$attendance_data['status']] ?? 'bg-gray-50' : 'bg-gray-50' ?>">

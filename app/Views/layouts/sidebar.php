    ...
    <div class="py-4 text-gray-500">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                <a href="<?=base_url('admin/dashboard')?>" class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800" href="#">

    ...
    <div class="py-4 text-gray-500">
        ...
        <ul>
                ...
                <li class="relative px-6 pt-4 pb-3"
                    ...
                    <ul x-show="isOpen" x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        <li
                            ...
                            <a href="<?= base_url('admin/tahun-ajaran') ?>" class="inline-flex w-full" href="#">Tahun
                                Ajaran</a>
                        </li>
                        <li
                        ...
                        <li
                            ...
                            <a href="<?= base_url('admin/nama-kegiatan') ?>" class="inline-flex w-full" href="#">Daftar
                                Kegiatan</a>
                        </li>
                    </ul>
                </li>
            ...
            <?php if ($role === 'Admin' || $role === "Guru"): // Menu ini hanya untuk Admin 
                    ?>
                <li class="relative px-6 pt-4 pb-3"
                    x-data="{ isOpen: <?= $segment3 == 'kegiatan-kelas' || $segment3 == 'kehadiran' ? 'true' : 'false' ?> }">
                    <button
                        class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800"
                        @click="isOpen = !isOpen" aria-haspopup="true">
                        <span class="inline-flex items-center">
                    ...
                    <ul x-show="isOpen" x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        aria-label="submenu">
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 <?= $segment3 == 'kehadiran' ? 'active' : '' ?>">
                            <a href="<?= base_url('admin/laporan/kehadiran') ?>" class="inline-flex w-full"
                                href="#">Kehadiran</a>
                        </li>
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 <?= $segment3 == 'kegiatan-kelas' ? 'active' : '' ?>">
                            <a href="<?= base_url('admin/laporan/kegiatan-kelas') ?>" class="inline-flex w-full"
                                href="#">Kegiatan</a>
                        </li>
                    </ul>
                </li>
            ...
            <?php if ($role === 'Admin'): // Menu ini hanya untuk Admin dan Guru
                    ?>
                ...
                <li class="relative px-6 pt-4 pb-3" x-data="{ isOpen: <?= $segment2 == 'laporan' ? 'true' : 'false' ?> }">
                    ...
                    <ul x-show="isOpen" x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a href="<?= base_url('admin/laporan/kehadiran') ?>" class="w-full">Kehadiran</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                            <a href="<?= base_url('admin/laporan/kegiatan-kelas') ?>" class="w-full">Kegiatan</a>
                        </li>
                    </ul>
                </li>
            <?php endif ?>
